...
class BoxDetailedMer extends StatefulWidget {
  static String routeName = "BoxMerDetailedScreen";
  @override
  _BoxDetailedMer createState() => _BoxDetailedMer();
}

class _BoxDetailedMer extends State<BoxDetailedMer> {
  int _quantity = 1;
  String path;
  Dish loadedBoxDish;
  String id;
  ...
  void initState() {
    loadedBoxDish =
        Provider.of<BoxDishProvider>(context, listen: false).findById("Mer");
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    "(1200) reviews",
                                    style: TextStyle(
                                        color: Colors.grey, fontSize: size.width / 28),
                                  ),
                                  Column(
                                    children: [
                                      MaterialButton(
