...
class BoxDetailedTerre extends StatefulWidget {
  static String routeName = "BoxTerreDetailedScreen";
  @override
  _BoxDetailedTerre createState() => _BoxDetailedTerre();
}

class _BoxDetailedTerre extends State<BoxDetailedTerre> {
  int _quantity = 1;
  String path;
  Dish loadedBoxDish;
  String id;
  ...
  void initState() {
    loadedBoxDish =
        Provider.of<BoxDishProvider>(context, listen: false).findById("Terre");
