...
import 'box_terre_detailed.dart';

class BoxScreenTerre extends StatelessWidget {
  Dish terreDish;

  BoxScreenTerre({
    @required this.terreDish,
  });
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  terreDish.description.length < 40
                                        ...
                                        child: OutlineButton(
                                          ...
                                          onPressed: () {
                                            Navigator.pushNamed(context,
                                                BoxDetailedTerre.routeName);
                                          },
                                        ),
                                      ),
                                    ),
                                    ButtonWidget(
                                        loadedDish: terreDish, quantity: 1),
                                  ],
                                ),
                              )
                            ],
